...
import { Star, Check, Plane, MapPin, Shield, Globe } from "lucide-react"
      ...
      <section className="bg-gradient-to-b from-blue-50 to-background py-12 md:py-16">
        <div className="container">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mb-4 text-4xl font-bold tracking-tight md:text-5xl">Best Travel Credit Cards of 2025</h1>
      ...
      <section className="bg-muted py-12">
        <div className="container">
          <div className="mx-auto max-w-4xl">
            <h2 className="mb-8 text-center text-3xl font-bold">How to Choose a Travel Credit Card</h2>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Focus on flexible redemption options and cards with no foreign transaction fees.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Cards with airline and hotel transfer partners often provide the best redemption value.
                    </p>
                  </div>
                  <div>
