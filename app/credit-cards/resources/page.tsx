...
export const metadata: Metadata = {
  title: "Credit Card Resources | Guides, Tools & Tips - FinanceWise",
  description:
    "Comprehensive credit card resources including guides, calculators, tools, and expert tips to help you make informed decisions.",
  keywords: "credit card resources, guides, calculators, tools, tips, education",
}
...
export default function CreditCardResourcesPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-12">
        <div className="container">
          <h2 className="mb-8 text-center text-3xl font-bold">Latest Credit Card Articles</h2>
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {allBlogs.map((blog, index) => (
              <BlogCard
                ...
                href={`/blog/credit-cards/${blog.slug}`}
                aosDelay={index * 100}
              />
            ))}
          </div>
      ...
      <section className="bg-primary py-12 text-primary-foreground">
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="mb-4 text-3xl font-bold">Need personalized credit card advice?</h2>
            <p className="mb-8 text-lg opacity-90">
              Use our tools and resources to find the perfect credit card for your unique financial situation and goals.
            </p>
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
