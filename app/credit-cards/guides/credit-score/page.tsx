...
export default function CreditScorePage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-12">
        <div className="container">
          <h2 className="mb-8 text-center text-3xl font-bold">Related Credit Guides</h2>
      ...
      <section className="bg-green-600 py-12 text-white">
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="mb-4 text-3xl font-bold">Start Monitoring Your Credit Today</h2>
            <p className="mb-8 text-lg opacity-90">
              Take control of your financial health by checking your credit score and monitoring it regularly. It's free
