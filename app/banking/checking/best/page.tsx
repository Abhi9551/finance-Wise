  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-muted py-12">
        <div className="container">
          <h2 className="mb-8 text-center text-3xl font-bold">Checking Account Articles</h2>
      ...
      <section className="bg-blue-600 py-12 text-white">
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="mb-4 text-3xl font-bold">Ready to open your new checking account?</h2>
            <p className="mb-8 text-lg opacity-90">
              Compare features and find the perfect checking account for your banking needs.
            </p>
